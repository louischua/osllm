...
def main():
    ...
    print(
        f"{'✅' if repo_success else '❌'} Repository Creation: {'PASSED' if repo_success else 'FAILED'}"
    )
    print(
        f"{'✅' if upload_success else '❌'} File Upload: {'PASSED' if upload_success else 'FAILED'}"
    )
