...
def main():
    ...
    results["pipeline_steps"].append({"step": server_test, "description": "Inference server test", "success": success})
    ...
    overall_success = (cli_success == total_cli and 
                      file_success == total_files and 
                      pipeline_success == total_pipeline)
