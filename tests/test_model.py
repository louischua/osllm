...
from model import Block, CausalSelfAttention, GPTConfig, GPTModel
...
class TestGPTModel(unittest.TestCase):
    ...
    def test_model_initialization(self):
        ...
        self.assertNotEqual(self.small_model.config.n_layer, self.medium_model.config.n_layer)
...
class TestModelPersistence(unittest.TestCase):
    ...
    def test_model_save_load(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            torch.save(
                {"model_state_dict": self.model.state_dict(), "config": self.config}, save_path
            )
